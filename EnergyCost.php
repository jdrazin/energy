...
class EnergyCost extends Root
{
     ...
     * @throws Exception
     */
    private function loadImportExport(): array { // get slot load, import and export tariffs for each slot
    ...
    protected function argSubstring($value): string {  // make argument substring
        return $value . ' ';
    }
    /**
     * @throws Exception
